...
def generate_launch_description():
    ...
    world_file = PathJoinSubstitution(
        [FindPackageShare("hunav_gazebo_wrapper"), "worlds", world_file_name]
    )
    ...
    pmb2_gazebo_launch = PathJoinSubstitution(
        [FindPackageShare("hunav_gazebo_wrapper"), "launch", "pmb2_hunav.launch.py"],
    )
    ...
    declare_arg_world = DeclareLaunchArgument(
        "base_world", default_value="house.world", description="Specify world file name"
    )
    ...
    declare_arg_namespace = DeclareLaunchArgument(
        "robot_namespace", default_value="", description="The type of robot"
    )
    ...
    declare_arg_laser = DeclareLaunchArgument(
        "laser_model",
        default_value="sick-571",
        description="the laser model to be used",
    )
    declare_arg_rgbd = DeclareLaunchArgument(
        "rgbd_sensors",
        default_value="True",
